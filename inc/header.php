        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <form class="d-flex gap-3" role="search">
                    ...
                    <div class="btn-group">
                        <a href="registration.html" class="btn btn-warning active d-flex align-items-center gap-2" aria-current="page"><i class="fa-solid fa-address-card d-flex align-items-center gap-2"></i>Registration</a>
                        <a href="login.html" class="btn btn-light"><i class="fa-solid fa-user"></i> Login</a>
                    </div>
                </form>
            </div>
        </div>
