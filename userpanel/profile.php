...
<div class="container-fluid ">
    <div class="row flex-nowrap">
        ...
        <!-- start-main content -->
        <div class="col-md-10  flex-shrink-1 mx-auto pb-5  ">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="assets/img/img_avatar2.png" alt="Admin" class="rounded-circle p-1 bg-dark" width="110">
                                        <div class="mt-3">
                                            <p class="text-muted">JPG or PNG no larger than 5 MB</p>
                                            <button class="btn btn-dark" type="button">Upload new image</button>
                                        </div>
                                    </div>
                                    <hr class="my-4">
